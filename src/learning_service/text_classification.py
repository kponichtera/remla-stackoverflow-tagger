...
ACCURACY_SCORE = Gauge('stackoverflow-tagger/model/accuracy_score', 'Model accuracy score')
F1_SCORE = Gauge('stackoverflow-tagger/model/f1_score', 'F1-score')
AVERAGE_PRECISION_SCORE = Gauge('stackoverflow-tagger/model/average_precision_score', 'Average precision score')
ROC_AUC = Gauge('stackoverflow-tagger/model/roc_auc', 'Area under the Receiver operating characteristic curve')
LATEST_MODEL_UPDATE = Gauge('stackoverflow-tagger/model/latest_model_update', 'Unix timestamp of the latest model update time')
